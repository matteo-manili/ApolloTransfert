 ...
 */
public class SmsClickatellHttp {
	 ...
	 */
	public SmsClickatellHttp(String userName, String apiId, String password) {
	...
	public boolean testAuth() throws UnknownHostException {
		try {
			...
			String urlParameters = "user="
					+ URLEncoder.encode(this.userName, Constants.ENCODING_UTF_8) + "&api_id="
					+ URLEncoder.encode(this.apiId, Constants.ENCODING_UTF_8) + "&password="
					+ URLEncoder.encode(this.password, Constants.ENCODING_UTF_8);
	...
	public Message sendMessage(String number, String messageContent)
		...
		String urlParameters = "user="
				+ URLEncoder.encode(this.userName, Constants.ENCODING_UTF_8) + "&api_id="
				+ URLEncoder.encode(this.apiId, Constants.ENCODING_UTF_8) + "&password="
				+ URLEncoder.encode(this.password, Constants.ENCODING_UTF_8) + "&to="
				+ URLEncoder.encode(number, Constants.ENCODING_UTF_8) + "&text="
				+ URLEncoder.encode(messageContent, Constants.ENCODING_UTF_8);
	...
	public Message[] sendMessage(String[] numbers, String messageContent)
		...
		String urlParameters = "user="
				+ URLEncoder.encode(this.userName, Constants.ENCODING_UTF_8) + "&api_id="
				+ URLEncoder.encode(this.apiId, Constants.ENCODING_UTF_8) + "&password="
				+ URLEncoder.encode(this.password, Constants.ENCODING_UTF_8) + "&text="
				+ URLEncoder.encode(messageContent, Constants.ENCODING_UTF_8) + "&to=";
	...
	public int getMessageStatus(String messageId) throws Exception {
		...
		// Build Parameters:
		urlParameters = "user=" + URLEncoder.encode(this.userName, Constants.ENCODING_UTF_8)
				+ "&api_id=" + URLEncoder.encode(this.apiId, Constants.ENCODING_UTF_8)
				+ "&password=" + URLEncoder.encode(this.password, Constants.ENCODING_UTF_8)
				+ "&apimsgid=" + URLEncoder.encode(messageId, Constants.ENCODING_UTF_8);
	...
	public double getCoverage(String number) throws Exception {
		...
		String urlParameters = "user="
				+ URLEncoder.encode(this.userName, Constants.ENCODING_UTF_8) + "&api_id="
				+ URLEncoder.encode(this.apiId, Constants.ENCODING_UTF_8) + "&password="
				+ URLEncoder.encode(this.password, Constants.ENCODING_UTF_8) + "&msisdn="
				+ URLEncoder.encode(number, Constants.ENCODING_UTF_8);
	...
	public Message[] sendAdvancedMessage(String[] numbers,
		...
		urlParameters = "user=" + URLEncoder.encode(this.userName, Constants.ENCODING_UTF_8)
				+ "&api_id=" + URLEncoder.encode(this.apiId, Constants.ENCODING_UTF_8)
				+ "&password=" + URLEncoder.encode(this.password, Constants.ENCODING_UTF_8)
				+ "&text=" + URLEncoder.encode(messageContent, Constants.ENCODING_UTF_8);
		...
		for (Entry<String, String> entry : features.entrySet()) {
			urlParameters += "&" + entry.getKey() + "="
					+ URLEncoder.encode(entry.getValue(), Constants.ENCODING_UTF_8);
		}
