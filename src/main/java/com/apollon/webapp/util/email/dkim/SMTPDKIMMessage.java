...
public class SMTPDKIMMessage extends SMTPMessage {
	...
	protected SMTPDKIMMessage(Session session, DKIMSigner signer) {
		super(session);
		this.signer = signer;
	}
	
	protected SMTPDKIMMessage(MimeMessage message, DKIMSigner signer) throws MessagingException {
		super(message);
		this.signer = signer;
	}

	protected SMTPDKIMMessage(Session session, InputStream is, DKIMSigner signer) throws MessagingException {
		super(session, is);
		this.signer = signer;
	}
