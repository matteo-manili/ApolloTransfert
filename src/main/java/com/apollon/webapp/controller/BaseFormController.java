...
public class BaseFormController implements ServletContextAware {
    ...
    protected String templateName = Constants.VM_EMAL_ACCUNT_CREATED;
     ...
     */
    /*
    protected void sendUserMessage(User user, String msg, String url, String subgect) throws MessagingException {
        ...
        //mailEngine. sendMessageHtml(recipients, null, message.getSubject(), templateName, model);
    }
     */
