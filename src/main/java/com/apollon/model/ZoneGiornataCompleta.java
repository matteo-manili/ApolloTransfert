 ...
 */
@Entity
@Table(name = "zone_giornata_completa")
public class ZoneGiornataCompleta extends BaseObject implements Serializable {
	private static final long serialVersionUID = -9034340789923129758L;
     ...
     */
    public ZoneGiornataCompleta() {
	}
    
	public ZoneGiornataCompleta(String nomeRegione, Long id) {
		this.id = id;
	}
	...
	@Column(name = "id_zone_giornata_completa")
	public Long getId() {
		return id;
	}
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ZoneGiornataCompleta)) {
            return false;
        }

        final ZoneGiornataCompleta tipoRuoloServiziDog = (ZoneGiornataCompleta) o;
