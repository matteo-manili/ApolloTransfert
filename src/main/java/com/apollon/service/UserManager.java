...
public interface UserManager extends GenericManager<User, Long> {
    ...
    User loadUserByTelephone(String phoneNumber) throws UsernameNotFoundException;
     ...
     */
    boolean sendPasswordRecoveryEmail(String username, String urlTemplate, HttpServletRequest request) throws NoSuchMessageException, Exception;
     ...
     * @return
     */
    User updatePassword(String username, String currentPassword, String recoveryToken, String newPassword, String applicationUrl, HttpServletRequest request) 
