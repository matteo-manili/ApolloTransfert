...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.apollon.service.impl.PasswordTokenManager#generateRecoveryToken(com.apollon.model.User)
     */
    @Override
    ...
    /**
     * @see com.apollon.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.apollon.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.apollon.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
